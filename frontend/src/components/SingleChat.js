...
import animationData from "../animations/typing-green.json";
...
const SingleChat = ({ fetchAgain, setFetchAgain }) => {
  ...
  return (
    ...
    {selectedChat
        ...
        : (
            <Box display='flex' alignItems='center' justifyContent='center' h='100%' backgroundColor="#282828" color="#AEBAC1">
